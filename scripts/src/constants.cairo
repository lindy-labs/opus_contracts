...
pub const INITIAL_STRK_THRESHOLD: u128 = 630000000000000000000000000; // 60% (Ray)
pub const INITIAL_STRK_PRICE: u128 = 700000000000000000; // 0.70 (Wad)
pub const INITIAL_STRK_BASE_RATE: u128 = 70000000000000000000000000; // 4% (Ray)
...
pub const INITIAL_WBTC_PRICE: u128 = 65000000000000000000000; // 65_000 (Wad)
