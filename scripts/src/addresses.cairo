...
pub mod sepolia {
    ...
    pub const fn pragma_spot_oracle() -> ContractAddress {
        0x36031daa264c24520b11d93af622c848b2499b66b41d611bac95e13cfca131a
            .try_into()
            .expect('invalid pragma spot address')
    }

    pub const fn pragma_twap_oracle() -> ContractAddress {
...
pub mod mainnet {
    ...
    pub const fn multisig() -> ContractAddress {
    ...
    pub const fn dai() -> ContractAddress {
    ...
    pub const fn usdt() -> ContractAddress {
    ...
    pub const fn ekubo_oracle_extension() -> ContractAddress {
    ...
    pub const fn ekubo() -> ContractAddress {
    ...
    pub const fn receptor() -> ContractAddress {
    ...
    pub const fn sstrk_gate() -> ContractAddress {
