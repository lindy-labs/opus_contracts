mod test_purger {
    ...
    use snforge_std::{
        CheatTarget, Event, EventSpyAssertionsTrait, EventSpyTrait, EventsFilterTrait, spy_events, start_prank,
        start_warp, stop_prank,
    };
                            ...
                            Option::Some(target_ltv) => {
                                ...
                                match absorb_type {
                                    ...
                                    AbsorbType::Partial => {
                                        ...
                                        absorber
                                            .provide(
                                                max((trove_debt.into() / 2_u128).into(), minimum_operational_shares),
                                            );
                                    },
                                    AbsorbType::None => {},
                                };
