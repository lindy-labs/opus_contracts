...
mod TestAbsorber {
    ...
    fn test_provide_after_threshold_absorption_above_minimum() {
        ...
        assert(second_provider_info.epoch == 2, 'wrong provider epoch');
        ...
        first_provider_info.epoch.print();
        assert(first_provider_info.epoch == 2, 'wrong provider epoch');
