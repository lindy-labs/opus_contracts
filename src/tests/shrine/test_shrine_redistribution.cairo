mod test_shrine_redistribution {
    ...
    use wadray::{Ray, RayZero, RAY_ONE, RAY_PERCENT, SignedWad, Wad, WadZero, WAD_ONE};
    ...
    fn preview_trove_redistribution(
        ...
        let mut cumulative_redistributed_debt: Wad = WadZero::zero();
        let mut cumulative_error = WadZero::zero();
    ...
    fn assert_redistribution_is_correct(
        ...
        let mut expected_recipient_trove_debt_increment = WadZero::zero();
        let mut cumulative_redistributed_debt = WadZero::zero();
    ...
    fn test_shrine_one_redistribution() {
        ...
        shrine.melt(trove1_owner, redistributed_trove, WadZero::zero());
        ...
        shrine.melt(trove1_owner, recipient_trove, WadZero::zero());
    ...
    fn test_shrine_two_redistributions() {
        ...
        start_prank(CheatTarget::All, shrine_utils::admin());
        shrine.melt(common::trove1_owner_addr(), redistributed_trove1, WadZero::zero());
        ...
        shrine.melt(common::trove2_owner_addr(), redistributed_trove2, WadZero::zero());
        ...
        shrine.melt(common::trove2_owner_addr(), recipient_trove, WadZero::zero());
        assert(shrine.get_trove_redistribution_id(recipient_trove) == expected_redistribution_id, 'wrong id');
                    ...
                    loop {
                        match pct_debt_to_redistribute_arr.pop_front() {
                            Option::Some(pct_debt_to_redistribute) => {
                                ...
                                shrine.melt(trove1_owner, recipient_trove1, WadZero::zero());
                                shrine.melt(trove1_owner, recipient_trove2, WadZero::zero());

                                assert(
                                    shrine.get_protocol_owned_troves_debt().is_zero(), 'wrong po debt after interest'
                                );

                                let excess: SignedWad = accrued_interest.into()
                                    - after_protocol_owned_troves_debt.into();
    ...
    fn test_shrine_redistribute_dust_yang_rounding() {
        ...
        shrine.melt(trove2_owner, redistributed_trove, WadZero::zero());
        ...
        loop {
            match pct_value_to_redistribute_arr.pop_front() {
                Option::Some(pct_value_to_redistribute) => {
                    ...
                    assert_eq!(
                        accrued_protocol_owned_troves_debt,
                        expected_protocol_owned_troves_debt,
    ...
    fn test_shrine_redistribution_only_one_trove_remaining() {
        ...
        // Trigger an update in trove 2 with an empty melt
        shrine.melt(trove1_owner, common::TROVE_2, WadZero::zero());
    ...
    fn test_reduction_of_protocol_owned_troves_debt() {
        ...
        loop {
            ...
            let mut target_trove_forge_amts: Span<Wad> = array![WadZero::zero(), WAD_ONE.into(),].span();
            ...
            match target_trove_forge_amts.pop_front() {
                Option::Some(target_trove_forge_amt) => {
                    ...
                    shrine.forge(trove1_owner, target_trove, target_trove_start_debt, 0_u128.into());
                    ...
                    assert_eq!(
                        protocol_owned_troves_debt,
                        protocol_owned_debt_amt,
                        "setup: wrong protocol owned troves debt amt"
                    );
                    ...
                    let protocol_owned_troves_debt: Wad = shrine.get_protocol_owned_troves_debt();
                    assert_eq!(
                        protocol_owned_troves_debt, expected_protocol_owned_troves_debt, "wrong po troves' debt"
                    );
                    ...
                    let expected_total_troves_debt: Wad = before_shrine_health.debt
                        + expected_total_troves_debt_increment;
