...
mod FlashBorrower {
    ...
    #[external(v0)]
    fn on_flash_loan(ref self: ContractState, 
        initiator: ContractAddress,
        token: ContractAddress,
        amount: u256,
        fee: u256,
        ...
        self.emit(FlashLoancall_dataReceived { initiator: initiator, token:  token, amount:  amount, fee:  fee, call_data:  call_data_copy });
